  ...
  return (
    <main>
      ...
      <article className="pagina-equipamento">
        ...
        <div className="padrao-midia-equipamento"><strong>Sequência de mídia</strong><span>1. equipamento sem fundo</span><span>2. equipamento no Centro</span><span>3. vídeo em operação</span><small>Somente mídias já recebidas são exibidas; espaços pendentes não usam conteúdo ilustrativo.</small></div>
