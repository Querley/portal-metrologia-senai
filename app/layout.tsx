...
import { PostHogAnalytics } from '../componentes/posthog-analytics';
import './globals.css';
...
export default function RootLayout({ children }: Readonly<{ children: React.ReactNode }>) {
  return <html lang="pt-BR"><body className={`${geistSans.variable} ${geistMono.variable}`}><PostHogAnalytics /><ValidacaoGlobal>{children}</ValidacaoGlobal><VLibras /></body></html>;
}
