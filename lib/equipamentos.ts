...
export const equipamentosPublicos: EquipamentoPublico[] = [
  {
    ...
    imagemPrincipal: '/imagens/zeiss-duramax-produto.webp',
    midias: [
      { tipo: 'imagem', src: '/imagens/zeiss-duramax-produto.webp', alt: 'Máquina de medição por coordenadas ZEISS DuraMax HTG', legenda: 'ZEISS DuraMax HTG' },
  ...
  },
  {
    ...
    imagemPrincipal: '/imagens/laboratorio-o-inspect.jpeg',
    midias: [
      { tipo: 'imagem', src: '/imagens/laboratorio-o-inspect.jpeg', alt: 'ZEISS O-INSPECT instalada no laboratório', legenda: 'ZEISS O-INSPECT no Centro' },
      { tipo: 'imagem', src: '/imagens/laboratorio-fachada-interna.jpeg', alt: 'Vista do laboratório com a ZEISS O-INSPECT', legenda: 'Integração ao laboratório' },
    ],
  ...
  },
  {
    ...
    imagemPrincipal: '/imagens/zeiss-prismo.webp',
    midias: [
      { tipo: 'imagem', src: '/imagens/zeiss-prismo.webp', alt: 'Máquina de medição por coordenadas ZEISS PRISMO', legenda: 'ZEISS PRISMO' },
      { tipo: 'imagem', src: '/imagens/laboratorio-prismo.jpeg', alt: 'ZEISS PRISMO instalada no Centro', legenda: 'PRISMO instalada no Centro' },
      { tipo: 'imagem', src: '/imagens/laboratorio-prismo-panoramica.jpeg', alt: 'Vista panorâmica da ZEISS PRISMO no laboratório', legenda: 'Área de medição da PRISMO' },
    ],
  ...
  },
  {
    ...
    imagemPrincipal: '/imagens/zeiss-bosello-max-produto.webp',
    midias: [
      { tipo: 'imagem', src: '/imagens/zeiss-bosello-max-produto.webp', alt: 'Sistema de raios X ZEISS BOSELLO MAX', legenda: 'ZEISS BOSELLO MAX' },
      { tipo: 'imagem', src: '/imagens/zeiss-bosello-max-laboratorio.webp', alt: 'ZEISS BOSELLO MAX em ambiente de laboratório', legenda: 'Sistema BOSELLO MAX' },
  ...
  },
  {
    ...
    imagemPrincipal: '/imagens/zeiss-atos-q.webp',
    midias: [
      { tipo: 'imagem', src: '/imagens/zeiss-atos-q.webp', alt: 'Scanner industrial ZEISS ATOS Q', legenda: 'ZEISS ATOS Q' },
      { tipo: 'imagem', src: '/imagens/laboratorio-atos-q.jpeg', alt: 'ZEISS ATOS Q instalada no Centro', legenda: 'ATOS Q no Centro' },
      { tipo: 'imagem', src: '/imagens/zeiss-atos-q-transporte.webp', alt: 'ZEISS ATOS Q em estojo de transporte', legenda: 'Sistema compacto e transportável' },
    ],
  ...
  },
  {
    ...
    imagemPrincipal: '/imagens/zeiss-t-scan-hawk-2.webp',
    midias: [
      { tipo: 'imagem', src: '/imagens/zeiss-t-scan-hawk-2.webp', alt: 'Scanner portátil ZEISS T-SCAN hawk 2', legenda: 'ZEISS T-SCAN hawk 2' },
      { tipo: 'imagem', src: '/imagens/zeiss-t-scan-em-uso.webp', alt: 'ZEISS T-SCAN hawk 2 digitalizando um componente', legenda: 'Digitalização manual em operação' },
    ],
