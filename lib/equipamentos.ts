...
export const equipamentosPublicos: EquipamentoPublico[] = [
  {
    ...
    imagemPrincipal: '/imagens/recorte-zeiss-duramax-v2.png',
    midias: [
      { tipo: 'imagem', src: '/imagens/recorte-zeiss-duramax-v2.png', alt: 'Máquina de medição por coordenadas ZEISS DuraMax HTG em fundo branco', legenda: 'Equipamento em fundo branco' },
  ...
  },
  {
    ...
    imagemPrincipal: '/imagens/recorte-zeiss-bosello-max-v2.png',
    midias: [
      { tipo: 'imagem', src: '/imagens/recorte-zeiss-bosello-max-v2.png', alt: 'Sistema de raios X ZEISS BOSELLO MAX em fundo branco', legenda: 'Equipamento em fundo branco' },
  ...
  },
  {
    ...
    imagemPrincipal: '/imagens/recorte-zeiss-t-scan-hawk-2-v2.png',
    midias: [
      { tipo: 'imagem', src: '/imagens/recorte-zeiss-t-scan-hawk-2-v2.png', alt: 'Scanner portátil ZEISS T-SCAN hawk 2 em fundo branco', legenda: 'Equipamento em fundo branco' },
    ],
