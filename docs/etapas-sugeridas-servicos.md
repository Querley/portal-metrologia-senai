...
1. Planejamento
2. Digitalização
3. Tratamento do modelo 3D
4. Validação
5. Entrega

## 2. Engenharia reversa e reconstrução CAD

1. Planejamento
2. Digitalização
3. Criação do modelo CAD
4. Validação
5. Entrega

## 3. Nacionalização e desenvolvimento de componentes

1. Planejamento
2. Medição da peça
3. Criação do modelo técnico
4. Validação
5. Entrega

## 4. Metrologia avançada e inspeção dimensional
...
## 5. Comparação CAD × peça física

1. Planejamento
2. Medição da peça
3. Comparação com o CAD
4. Validação do relatório
5. Entrega
...
1. Planejamento
2. Medições
3. Análise do desgaste
4. Validação do mapa e relatório
5. Entrega

## 7. Tomografia industrial

1. Planejamento
2. Escaneamento tomográfico
3. Processamento das imagens
4. Validação do relatório
5. Entrega

## 8. Análise de falhas, quebras e anomalias

1. Planejamento
2. Medição e inspeção
3. Análise da falha
4. Validação do relatório
5. Entrega

## 9. Árvore de equipamentos e peças críticas
...
## 10. Almoxarifado virtual e biblioteca digital

1. Planejamento
2. Digitalização dos itens
3. Organização dos modelos
4. Validação
5. Disponibilização
