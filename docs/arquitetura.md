...
Desde a migration `202609150042_cms_publico_multilingue.sql`, o CMS possui versões imutáveis e um ponteiro de publicação independente por conteúdo e idioma. A leitura pública ocorre somente pela RPC `listar_conteudos_publicados`, que prioriza o idioma solicitado e sinaliza quando usa o conteúdo canônico PT-BR como fallback. Edição, histórico e publicação passam por RPCs exclusivas do Administrador e geram auditoria. Catálogo, Solicitação e Privacidade já consomem seus cabeçalhos do CMS; o restante das páginas públicas e da área do Cliente será migrado progressivamente. A área interna dos funcionários permanece somente em português.
