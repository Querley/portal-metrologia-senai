...
## Cabeçalho, contato e privacidade — lote 049

Homologar em desktop a 100% de zoom e em celular: comparar o cabeçalho da página inicial, Catálogo, Equipamentos e Privacidade; nenhum link ou botão pode quebrar linha. Em largura intermediária, deve aparecer o menu compacto. Na página inicial, clicar em “Copiar” no contato por e-mail e confirmar o pop-up no canto superior direito. Em “Soluções organizadas por setor”, confirmar que o fundo azul termina junto aos controles e não forma uma área vazia. Abrir “Privacidade” em PT-BR, inglês e alemão e conferir compromissos, dados, finalidades, proteção, direitos, incidentes, ética, referências oficiais e contato. A redação deve passar por validação institucional antes da operação com dados reais, especialmente quanto à identificação formal do controlador e encarregado, bases legais por finalidade e prazos de retenção.
