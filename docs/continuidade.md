...
O job `banco-e-rls` passou a repetir somente a inicialização local do Supabase quando o registro de imagens responde com limitação temporária. As migrations, a recriação do banco e as provas pgTAP continuam obrigatórias e inalteradas.
