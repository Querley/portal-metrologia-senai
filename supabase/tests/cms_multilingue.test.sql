...
('d1000000-0000-0000-0000-000000000003','00000000-0000-0000-0000-000000000000','authenticated','authenticated','validador.cms@empresa.com.br','',now(),'{}','{}',now(),now());
...
('d1000000-0000-0000-0000-000000000003','Validador CMS','validador','demonstracao');
...
select throws_ok($$select salvar_versao_conteudo_demonstrativo('inicio.negado','secao','pt-BR','Conteúdo negado','{"texto":"Texto que não deve ser gravado pelo perfil técnico."}'::jsonb)$$,'Somente Validador ou Administrador pode editar o Conteúdo Público.','Técnico não edita o CMS');
